...
export default function Header() {
    return (
    <header className=" shadow-sm rounded-md p-4 my-4 mx-4 flex flex-col  bg-orange-500">
        ...
        <a className="font-bold text-orange-900 text-xl" href="/">wando-ui</a>
			...
			<h1 className='pb-4 text-3xl text-orange-200 font-semibold'>Minimal, component collection.</h1>
