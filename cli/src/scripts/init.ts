...
export default async function initWandoUI(): Promise<void> {
    ...
    const tailwindConfigUrl: string = 'https://raw.githubusercontent.com/iamseeley/wando-ui/tailwind.config.ts';
    const globalsCssUrl: string = 'https://raw.githubusercontent.com/iamseeley/wando-ui/app/globals.css';
